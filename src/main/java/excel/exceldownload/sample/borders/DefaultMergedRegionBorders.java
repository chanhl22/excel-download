...
public class DefaultMergedRegionBorders implements ExcelMergedRegionBorders {
    ...
    @Builder
    private DefaultMergedRegionBorders(BorderStyle borderStyle, IndexedColors borderColor) {
    ...
    public static DefaultMergedRegionBorders create() {
        return DefaultMergedRegionBorders.builder()
